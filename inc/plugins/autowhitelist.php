...
function autowhitelist_info()
{
	return array(
		...
		"website"		=> "http://hiraeth.at/ashes",
		"author"		=> "Joe Riker",
		"authorsite"	=> "http://hiraeth.at/ashes",
		"version"		=> "1.0",
		"compatibility" => "*"
	);
}
...
function autowhitelist_install(){
	...
	$setting_array = array(
	  ...
	  'npcGroup' => array(
          ...
          'description' => 'Gib die ID der Admingruppe an.',
          'optionscode' => 'text',
          'value' => '1', // Default
          'disporder' => 4
      ),
...
function autowhitelist_pleasewhite() {
	...
	if($mybb->user['stillthere'] == 0) eval('$pleasewhitelist = "'.$templates->get('whitelist_makewhite_bit').'";');
